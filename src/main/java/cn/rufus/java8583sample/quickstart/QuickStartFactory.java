 ...
 */
package cn.rufus.java8583sample.quickstart;
...
class QuickStartFactory {
	...
	public static Iso8583MessageFactory forQuickStart(){
		...
		factory.set( 2, new Iso8583FieldType(Iso8583FieldType.FieldTypeValue.LLVAR_NUMERIC,0).setFillBlankStrategy(Iso8583FillBlankStrategy.rightAppendStrategy('F', false)))
			   ...
			   .set( 4, new Iso8583FieldType(Iso8583FieldType.FieldTypeValue.NUMERIC,12).setFillBlankStrategy(Iso8583FillBlankStrategy.leftAppendStrategy('0', false)))
			   ...
			   .set(48, new Iso8583FieldType(Iso8583FieldType.FieldTypeValue.LLLVAR_NUMERIC,0).setFillBlankStrategy(Iso8583FillBlankStrategy.leftAppendStrategy('F', false)))
			   ...
			   .set(62, new Iso8583FieldType(Iso8583FieldType.FieldTypeValue.LLLVAR_BYTE_NUMERIC,0))
